...
func TestMistCollector_Collect(t *testing.T) {
	...
	t.Run("OrgMetrics", func(t *testing.T) {
		expected := `
			...
			# HELP mist_org_sites Number of sites in the organization
			# TYPE mist_org_sites gauge
			mist_org_sites{country_code="US",site_id="site-1",site_name="Test Site"} 1
		...
		err := testutil.CollectAndCompare(collector, strings.NewReader(expected),
			"mist_org_alarms", "mist_org_tickets", "mist_org_sites")
		if err != nil {
	...
	t.Run("DeviceMetrics", func(t *testing.T) {
		expected := `
			...
			mist_device_channel{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",radio="band_24",site_id="site-1"} 6
			mist_device_channel{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",radio="band_5",site_id="site-1"} 36
			# HELP mist_device_clients Number of clients connected to the device
			# TYPE mist_device_clients gauge
			mist_device_clients{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",radio="band_24",site_id="site-1"} 5
			mist_device_clients{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",radio="band_5",site_id="site-1"} 10
			# HELP mist_device_last_seen Device last seen time
			# TYPE mist_device_last_seen gauge
			mist_device_last_seen{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",site_id="site-1"} 1.6725312e+09
			# HELP mist_device_power Device's transmit power (dBm)
			# TYPE mist_device_power gauge
			mist_device_power{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",radio="band_24",site_id="site-1"} 17
			mist_device_power{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",radio="band_5",site_id="site-1"} 20
			# HELP mist_device_rx_bps Device's receive rate (bps)
			# TYPE mist_device_rx_bps gauge
			mist_device_rx_bps{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",site_id="site-1"} 2000
			# HELP mist_device_rx_bytes Device's received bytes
			# TYPE mist_device_rx_bytes gauge
			mist_device_rx_bytes{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",radio="band_24",site_id="site-1"} 2048
			mist_device_rx_bytes{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",radio="band_5",site_id="site-1"} 8192
			# HELP mist_device_tx_bps Device's transmit rate (bps)
			# TYPE mist_device_tx_bps gauge
			mist_device_tx_bps{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",site_id="site-1"} 1000
			# HELP mist_device_tx_bytes Device's transmitted bytes
			# TYPE mist_device_tx_bytes gauge
			mist_device_tx_bytes{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",radio="band_24",site_id="site-1"} 1024
			mist_device_tx_bytes{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",radio="band_5",site_id="site-1"} 4096
			# HELP mist_device_uptime Device uptime (s)
			# TYPE mist_device_uptime gauge
			mist_device_uptime{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",site_id="site-1"} 86400
			# HELP mist_device_wlans Number of WLANs assigned to the device
			# TYPE mist_device_wlans gauge
			mist_device_wlans{device_hw_rev="1.0",device_id="device-1",device_model="AP43",device_name="AP One",device_type="ap",site_id="site-1"} 2
		`
		err := testutil.CollectAndCompare(collector, strings.NewReader(expected),
	...
	t.Run("ClientMetrics", func(t *testing.T) {
		expected := `
			...
			mist_client_last_seen{ap_id="device-1",ap_mac="",client_mac="aa:bb:cc:dd:ee:ff",family="",hostname="test-client",manufacture="",model="",os="macOS",ssid="TestSSID",username=""} 1.672531201e+09
			# HELP mist_client_idletime Client idle time (s), since the last RX packet
			# TYPE mist_client_idletime gauge
			mist_client_idletime{ap_id="device-1",ap_mac="",client_mac="aa:bb:cc:dd:ee:ff",family="",hostname="test-client",manufacture="",model="",os="macOS",ssid="TestSSID",username=""} 10
			# HELP mist_client_rssi Client's received signal strength indicator (dBm)
			# TYPE mist_client_rssi gauge
			mist_client_rssi{ap_id="device-1",ap_mac="",client_mac="aa:bb:cc:dd:ee:ff",family="",hostname="test-client",manufacture="",model="",os="macOS",ssid="TestSSID",username=""} -60
			# HELP mist_client_rx_bytes Client's received bytes
			# TYPE mist_client_rx_bytes gauge
			mist_client_rx_bytes{ap_id="device-1",ap_mac="",client_mac="aa:bb:cc:dd:ee:ff",family="",hostname="test-client",manufacture="",model="",os="macOS",ssid="TestSSID",username=""} 1024
			# HELP mist_client_snr Client's signal to noise ratio
			# TYPE mist_client_snr gauge
			mist_client_snr{ap_id="device-1",ap_mac="",client_mac="aa:bb:cc:dd:ee:ff",family="",hostname="test-client",manufacture="",model="",os="macOS",ssid="TestSSID",username=""} 30
			# HELP mist_client_tx_bytes Client's transmitted bytes
			# TYPE mist_client_tx_bytes gauge
			mist_client_tx_bytes{ap_id="device-1",ap_mac="",client_mac="aa:bb:cc:dd:ee:ff",family="",hostname="test-client",manufacture="",model="",os="macOS",ssid="TestSSID",username=""} 512
			# HELP mist_client_uptime Client connected time (s)
			# TYPE mist_client_uptime gauge
			mist_client_uptime{ap_id="device-1",ap_mac="",client_mac="aa:bb:cc:dd:ee:ff",family="",hostname="test-client",manufacture="",model="",os="macOS",ssid="TestSSID",username=""} 3600
		`
		err := testutil.CollectAndCompare(collector, strings.NewReader(expected),
